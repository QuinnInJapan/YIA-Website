...
const SECTION_CONFIGS: Partial<Record<SectionTypeName, SectionConfig>> = {
    ...
    lists: [
      {
        ...
        addLabel: "+ 連絡先を追加",
        fields: [
          { key: "nameJa", label: "名前", type: "string" },
          { key: "tel", label: "電話番号", type: "string" },
    ...
    lists: [
      {
        ...
        subType: "sisterCity",
        fields: [
          { key: "name", label: "都市名", type: "bilingualInput" },
          { key: "country", label: "国名", type: "bilingualInput" },
          { key: "note", label: "備考", type: "string" },
        ],
      },
    ],
  },
  fairTrade: {
    showTitle: true,
    fields: [
      { key: "description", label: "説明", type: "bilingualTextarea" },
      { key: "delivery", label: "配送情報", type: "bilingualTextarea" },
    ],
    lists: [
      {
        key: "priceList",
        ...
        addLabel: "+ 商品を追加",
        fields: [
          { key: "type", label: "種類", type: "bilingualInput" },
          { key: "weight", label: "重量", type: "bilingualInput" },
          { key: "price", label: "価格", type: "bilingualInput" },
        ],
      },
    ],
  },
    ...
    lists: [
      {
        ...
        addLabel: "+ チラシを追加",
        subType: "eventFlyer",
        fields: [{ key: "alt", label: "代替テキスト", type: "bilingualInput" }],
      },
    ],
  },
};
